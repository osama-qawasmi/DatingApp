...
namespace API.Controllers
{
    public class AdminController : BaseApiController
    {
        ...
        [Authorize(Policy = "RequiredAdminOrModeratorRole")]
        [HttpGet("photos-for-moderation")]
        public ActionResult GetPhotoForModeration()
        {
            return Ok("Only Admin or Moderator can access");
        }
        ...
        {
            if(string.IsNullOrEmpty(roles)) return BadRequest("You must select one role at least");
